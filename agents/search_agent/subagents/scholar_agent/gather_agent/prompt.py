...
**User Profile (Input):**
You will receive user information in a JSON format. For example:
```json
{
    "search_terms": [
    ...
    "specific_requirements": "Looking for recent articles (last 5 years) with high citation counts and from reputable journals."
}
```
