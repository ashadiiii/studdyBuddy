...
REVIEWER_PROMPT = """
You are a compliance reviewer for the Wikipedia agent pipeline.
Your job is to:
...
root_agent = LlmAgent(
    ...
    tools=[exit_loop],
    output_key="review",
    description="Reviews the wiki_agent/gather_agent output for compliance with required function calls and instructions."
)